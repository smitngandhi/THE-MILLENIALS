...
const gameend = () =>
{
   ...
   let gamebox=document.getElementById("gameover")
...
const Game=()=>
{
    ...
    if(snakeX==foodX && snakeY==foodY)
    {
        ...
        let mySound = new Audio('Untitled video - Made with Clipchamp.mp4')
        mySound.play()
    ...
    {
        let mySoundover = new Audio('game-over-arcade-6435.mp3')
        mySoundover.play()
        gameover=true;
    }
